...
/**
 * The persistent class for the tb_invpodetails database table.
 * 
 */
@Entity
@Table(name="tb_invpodetails")
@NamedQuery(name="TbInvpodetail.findAll", query="SELECT t FROM TbInvpodetail t")
public class TbInvpodetail  {
